...
def analyze():
    ...
    for i in range(0, len(scrap_queries_df['query'])):
        ...
        ss_df.to_csv('sentiment/sid/%s.csv' % scrap_queries_df['name'][i])
        ...
        positive_df.to_csv('sentiment/tex2emo/positive_%s.csv' % scrap_queries_df['name'][i])
        negative_df.to_csv('sentiment/tex2emo/negative_%s.csv' % scrap_queries_df['name'][i])
